...
// contract BishopNFT is ERC721, ERC721URIStorage {
...
//     constructor() ERC721("BishopNFT", "BISHOP"){}

//     // Generate On-Chain SVG Image
...
//             '{'
//                 '"name": "Bishop NFT #', tokenId.toString(),'", ',
//                 '"description": " NFT",',
//                 '"image": "', generateNFTCharacter(tokenId),'"',
//             '}'
//         );
